	...
	<body>
		...
		<div id="show-image" class="content scaffold-show" role="main">
			...
			<ol class="property-list image">
				...
				<g:if test="${imageInstance?.imgurCode}">
				<li class="fieldcontain">
					<span id="imgurCode-label" class="property-label"><g:message code="image.imgurCode.label" default="Imgur Code" /></span>
					
						<span class="property-value" aria-labelledby="imgurCode-label"><g:fieldValue bean="${imageInstance}" field="imgurCode"/></span>
