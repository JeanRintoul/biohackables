		...
		<div id="list-image" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="imgurCode" title="${message(code: 'image.imgurCode.label', default: 'Imgur Code')}" />
				...
				<g:each in="${imageInstanceList}" status="i" var="imageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${imageInstance.id}">${fieldValue(bean: imageInstance, field: "imgurCode")}</g:link></td>
