		...
		<div id="list-video" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="youTubeCode" title="${message(code: 'video.youTubeCode.label', default: 'You Tube Code')}" />
				...
				<g:each in="${videoInstanceList}" status="i" var="videoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${videoInstance.id}">${fieldValue(bean: videoInstance, field: "youTubeCode")}</g:link></td>
